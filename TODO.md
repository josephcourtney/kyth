...
- implement Phase 11 from `PLAN.md`: first refactor browser invalidation to represent uncertainty per changed path without changing fallback behavior, then add explicit source-glob → URL-glob conservative fallback scopes;
